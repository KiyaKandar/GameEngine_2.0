...
public:
	...
	NCLVector2 GetRelativePosition() const;
	//Get the window position of the mouse pointer
	NCLVector2 GetAbsolutePosition() const;
	...
	NCLVector2 GetAbsoluteBounds() const
	{
		return absolutePositionBounds;
	};
