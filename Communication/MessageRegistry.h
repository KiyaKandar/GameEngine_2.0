...
#define REGISTER_ALL_TRACKED_SENDERS()\
	...
	REGISTER_GLOBAL_TRACKED_MESSAGE_SENDER(DummyWorkMessage)\
	REGISTER_GLOBAL_TRACKED_MESSAGE_SENDER(UIQuadBatchMessage)
...
#define REGISTER_ALL_TRACKED_SENDERS_DELETION()\
	...
	REGISTER_GLOBAL_TRACKED_MESSAGE_SENDER_DELETION(UIQuadBatchMessage)\
	REGISTER_GLOBAL_TRACKED_MESSAGE_SENDER_DELETION(DummyWorkMessage)
...
#define INITIALISE_GLOBAL_TRACKED_SENDERS(OWNER_CLASS)\
	...
	REGISTER_GLOBAL_SENDER_INITIALISATION(UIQuadBatchMessage, OWNER_CLASS)\
	REGISTER_GLOBAL_SENDER_INITIALISATION(DummyWorkMessage, OWNER_CLASS)
...
#define REGISTER_ALL_SENDER()\
	...
	REGISTER_MESSAGE_SENDER(UIQuadBatchMessage)\
	REGISTER_MESSAGE_SENDER(DummyWorkMessage)
